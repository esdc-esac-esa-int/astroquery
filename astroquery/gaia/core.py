...
class GaiaClass(TapPlus):
    ...
    def load_data(self, ids, *, data_release=None, data_structure='INDIVIDUAL', retrieval_type="ALL",
        ...
        retrieval_type : str, optional, default 'ALL' to retrieve all data  from the list of sources
            ...
            'RVS_EPOCH_DATA_DOUBLE','EPOCH_SPECTRUM_RVS', 'RVS_TRANSIT', 'EPOCH_ASTROMETRY_CROWDED_FIELD',
            'EPOCH_PHOTOMETRY_CROWDED_FIELD', 'EPOCH_IMAGE', 'EPOCH_PHOTOMETRY_CCD', 'EPOCH_SPECTRUM_XP_SSO',
            'EPOCH_SPECTRUM_XP_CROWDING', 'XP_MEAN_SPECTRUM', 'EPOCH_SPECTRUM_XP', 'CROWDED_FIELD_IMAGE',
