...
class DummyTapHandler(object):
    ...
    def load_job_metadata(self,jobid=None, offset=None, pagesize=None, allstrings=None, verbose=False):
        self.__invokedMethod = 'load_job_metadata'
        self.__parameters['jobid'] = jobid
        self.__parameters['offset'] = offset
        self.__parameters['pagesize'] = pagesize
        self.__parameters['allstrings'] = allstrings
        self.__parameters['verbose'] = verbose
